...
const Alcance = ({ onClose, onAddalcance, onEditalcance, actionType }) => {
    const { formState, categories, isSubmitting, errors, handleInputChange, handleSubmit } = useAlcanceForm();
