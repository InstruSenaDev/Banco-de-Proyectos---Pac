  ...
  return (
    <LayoutPrincipal2 title="">
      {loading ? (
            ...
            <div className="w-1/2 mx-auto">
              <div className="flex font-josefin-slab flex-col space-y-12">
                ...
                <div>
                  ...
                  ></textarea>
                  <span className="text-red-500 text-sm">{errors.impacto}</span>
                </div>
                <div>
                  <Input
                    type="text"
        ...
        <span className="text-red-500 text-sm sm:col-span-3">{errors.frecuencia}</span>
      </div>
                ...
                <div className="grid sm:grid-cols-3 gap-x-8 sm:gap-y-4 mt-4">
                  ...
                  <RadioButton2
                    ...
                    onChange={handleDiaChange}
                  />
                  <span className="text-red-500 text-sm sm:col-span-3">{errors.dias}</span>
                </div>
