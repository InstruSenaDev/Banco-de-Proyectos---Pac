...
import './CartaUsuario.css'; // Asegúrate de tener este archivo con los estilos
...
const CartaUsuario = ({ Text }) => {
    return (
        <div className="w-full sm:w-5/6 md:w-80 h-auto sm:h-60 bg-[#FBFCFF] rounded-xl border-2 border-[#FBFCFF] shadow-lg flex flex-col items-center justify-center p-4 sm:p-8 mb-4 sm:m-8">
            <h2 className="text-base sm:text-xl md:text-2xl font-nunito-sans mb-2 sm:mb-4 text-center leading-tight p-2 sm:p-4 font-bold">
                {Text}
            </h2>
            <button className="group cursor-pointer outline-none hover:rotate-90 duration-300">
                <svg className="stroke-[#A3E784] fill-none group-active:duration-0 duration-300"
                    viewBox="0 0 24 24"
                    height="60px"
                    width="60px"
